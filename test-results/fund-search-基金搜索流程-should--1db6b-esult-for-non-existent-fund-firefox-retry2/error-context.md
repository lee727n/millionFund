...
- Name: fund-search.spec.ts >> 基金搜索流程 >> should show empty result for non-existent fund
- Location: e2e\fund-search.spec.ts:76:3
...
Locator: locator('[data-test-id="empty-result"]')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('[data-test-id="empty-result"]')

```

```yaml
- text:  搜索基金 
- searchbox "输入基金代码或名称": "999999"
- text: 
- button "取消"
- text: 新华安享惠泽39个月定开债A 004567 债券型-长债 --  汇添富90天短债A 007456 债券型-中短债 --  汇添富90天短债B 007457 债券型-中短债 --  汇添富90天短债C 007458 债券型-中短债 --  南方恒新39个月A 007567 债券型-长债 --  南方恒新39个月C 007568 债券型-长债 --  汇添富盛安39个月定开债 007948 债券型-长债 --  国寿安保安泽39个月定开债 007970 债券型-长债 --  万家惠享39个月定开债 007979 债券型-长债 --  银华稳晟39个月定开债 008002 债券型-长债 --  华富安兴39个月定开债A 008018 债券型-长债 --  华富安兴39个月定开债C 008019 债券型-长债 --  工银泰和39个月定开债券A 008027 债券型-长债 --  国联睿嘉39个月定开债券A 008046 债券型-长债 --  国联睿嘉39个月定开债券C 008047 债券型-长债 --  博时稳欣39个月定开债 008117 债券型-长债 --  景顺长城弘利39个月定开债 008333 债券型-长债 --  嘉实安元39个月定期纯债A 008338 债券型-长债 --  嘉实安元39个月定期纯债C 008339 债券型-长债 --  招商招和39个月定开债 008460 债券型-长债 --  天弘鑫意39个月定开债 008478 债券型-长债 --  华商鸿畅39个月定开利率债A 008489 债券型-长债 --  华商鸿畅39个月定开利率债C 008490 债券型-长债 --  安信丰泽39个月定开债 008523 债券型-长债 --  中邮淳悦39个月定开债A 008560 债券型-长债 --  中邮淳悦39个月定开债C 008561 债券型-长债 --  平安乐顺39个月定开债A 008596 债券型-长债 --  平安乐顺39个月定开债C 008597 债券型-长债 --  华泰柏瑞锦兴39个月定开债 008649 债券型-长债 --  方正富邦禾利39个月定开债A 008669 债券型-长债 -- 
```
...
> 106 |     await expect(this.emptyResultMessage).toBeVisible()
  ...
  156 |     const code = (await item.locator('[data-test-id="fund-code"]').textContent()) || ''
  157 |     const name = (await item.locator('[data-test-id="fund-name"]').textContent()) || ''
  158 |     return { code, name }
  159 |   }
  160 | }
  161 | 
```