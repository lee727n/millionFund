...
- Name: fund-detail.spec.ts >> 基金详情查看流程 >> should display valuation change with correct color
- Location: e2e\fund-detail.spec.ts:136:3
...
Call log:
  - waiting for locator('[data-testid="valuation-change"]')
