...
- Name: fund-detail.spec.ts >> 基金详情查看流程 >> should refresh valuation when clicking refresh button
- Location: e2e\fund-detail.spec.ts:111:3
...
Call log:
  - waiting for locator('[data-testid="valuation"]')
